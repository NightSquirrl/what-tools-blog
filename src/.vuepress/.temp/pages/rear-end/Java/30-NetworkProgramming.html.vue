<template><div><h2 id="_1-网络编程入门" tabindex="-1"><a class="header-anchor" href="#_1-网络编程入门"><span>1. 网络编程入门</span></a></h2>
<h3 id="_1-1-网络编程概述" tabindex="-1"><a class="header-anchor" href="#_1-1-网络编程概述"><span>1.1 网络编程概述</span></a></h3>
<ul>
<li>
<p>计算机网络</p>
...
<h3 id="_1-2-网络编程三要素" tabindex="-1"><a class="header-anchor" href="#_1-2-网络编程三要素"><span>1.2 网络编程三要素</span></a></h3>
<ul>
<li>
<p>IP地址</p>
...
<h3 id="_1-3-ip地址" tabindex="-1"><a class="header-anchor" href="#_1-3-ip地址"><span>1.3 IP地址</span></a></h3>
...
<h3 id="_1-4-inetaddress" tabindex="-1"><a class="header-anchor" href="#_1-4-inetaddress"><span>1.4 InetAddress</span></a></h3>
...
<li>
<p>代码演示</p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">InetAddressDemo</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">UnknownHostException</span> <span class="token punctuation">{</span>
        ...
        <span class="token class-name">InetAddress</span> address <span class="token operator">=</span> <span class="token class-name">InetAddress</span><span class="token punctuation">.</span><span class="token function">getByName</span><span class="token punctuation">(</span><span class="token string">"192.168.1.66"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>

        <span class="token comment">//public String getHostName()：获取此IP地址的主机名</span>
        <span class="token class-name">String</span> name <span class="token operator">=</span> address<span class="token punctuation">.</span><span class="token function">getHostName</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token comment">//public String getHostAddress()：返回文本显示中的IP地址字符串</span>
...
<h3 id="_1-5-端口和协议" tabindex="-1"><a class="header-anchor" href="#_1-5-端口和协议"><span>1.5 端口和协议</span></a></h3>
<ul>
<li>
<p>端口</p>
<ul>
...
<p>端口号</p>
<ul>
<li>用两个字节表示的整数，它的取值范围是0<sub>65535。其中，0</sub>1023之间的端口号用于一些知名的网络服务和应用，普通的应用程序需要使用1024以上的端口号。如果端口号被另外一个服务或应用所占用，会导致当前程序启动失败</li>
</ul>
</li>
<li>
<p>协议</p>
...
<h2 id="_2-udp通信程序" tabindex="-1"><a class="header-anchor" href="#_2-udp通信程序"><span>2.UDP通信程序</span></a></h2>
<h3 id="_2-1-udp发送数据" tabindex="-1"><a class="header-anchor" href="#_2-1-udp发送数据"><span>2.1 UDP发送数据</span></a></h3>
<ul>
<li>
<p>Java中的UDP通信</p>
<ul>
...
<li>
<p>代码演示</p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">SendDemo</span> <span class="token punctuation">{</span>
...
<h3 id="_2-2udp接收数据" tabindex="-1"><a class="header-anchor" href="#_2-2udp接收数据"><span>2.2UDP接收数据</span></a></h3>
<ul>
<li>
<p>接收数据的步骤</p>
<ul>
...
<li>
<p>示例代码</p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ReceiveDemo</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
...
<h3 id="_2-3udp通信程序练习" tabindex="-1"><a class="header-anchor" href="#_2-3udp通信程序练习"><span>2.3UDP通信程序练习</span></a></h3>
<ul>
<li>
<p>案例需求</p>
...
<h3 id="_2-4udp三种通讯方式" tabindex="-1"><a class="header-anchor" href="#_2-4udp三种通讯方式"><span>2.4UDP三种通讯方式</span></a></h3>
<ul>
<li>
<p>单播</p>
...
<h3 id="_2-5udp组播实现" tabindex="-1"><a class="header-anchor" href="#_2-5udp组播实现"><span>2.5UDP组播实现</span></a></h3>
<ul>
<li>
<p>实现步骤</p>
<ul>
...
<li>
<p>代码实现</p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token comment">// 发送端</span>
...
<h3 id="_2-6udp广播实现" tabindex="-1"><a class="header-anchor" href="#_2-6udp广播实现"><span>2.6UDP广播实现</span></a></h3>
<ul>
<li>
<p>实现步骤</p>
<ul>
...
<p>##3. TCP通信程序</p>
<h3 id="_3-1tcp发送数据" tabindex="-1"><a class="header-anchor" href="#_3-1tcp发送数据"><span>3.1TCP发送数据</span></a></h3>
<ul>
<li>
<p>Java中的TCP通信</p>
<ul>
...
<li>
<p>示例代码</p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Client</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
...
<h3 id="_3-2tcp接收数据" tabindex="-1"><a class="header-anchor" href="#_3-2tcp接收数据"><span>3.2TCP接收数据</span></a></h3>
<ul>
<li>
<p>构造方法</p>
<table>
...
<p>三次握手和四次挥手</p>
<ul>
<li><img src="https://img.picgo.net/2023/11/06/07_TCPe1d432c6585012c9.png" alt="07_TCP三次握手" tabindex="0" loading="lazy"><figcaption>07_TCP三次握手</figcaption></li>
</ul>
</li>
<li>
<p>四次挥手</p>
<ul>
<li><img src="https://img.picgo.net/2023/11/06/image-20231106200054397dc5c73343393cbcb.png" alt="image-20231106200054397" tabindex="0" loading="lazy"><figcaption>image-20231106200054397</figcaption></li>
</ul>
</li>
<li></li>
</ul>
